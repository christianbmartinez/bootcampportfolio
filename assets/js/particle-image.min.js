const ParticleImageDisplayer = function (tag_id, canvas_el, params) {
  ...
  this.pImageConfig = {
    particles: {
      ...
      movement: { speed: 1, restless: { enabled: false, value: 10 } },
      interactivity: {
    ...
    image: {
      src: { path: null, is_external: false },
      size: { canvas_pct: 60, min_px: 50, max_px: 800 },
    },
    interactions: {
      repulse: { distance: 100, strength: 200 },
      big_repulse: { distance: 100, strength: 500 },
      grab: { distance: 100, line_width: 1 },
    },
    canvas: {
      el: canvas_el,
